...
-- Index for faster filtering (partial indexes for non-test records)
CREATE INDEX IF NOT EXISTS idx_agent_messages_is_test ON agent_messages(is_test);
CREATE INDEX IF NOT EXISTS idx_token_usage_is_test ON token_usage(is_test);
